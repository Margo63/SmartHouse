...
class MainActivity : AppCompatActivity() {
    ...
    private fun showInformationForDevice() {//d[sel].typeIndex не меняется??
        ...
        //Toast.makeText(this, d[sel].typeIndex, Toast.LENGTH_SHORT).show()
